...
arquivo_csv = "saidas/mozilla_comprimido.bin_grafico.csv"  # troque pelo arquivo problemático
...
ax1.plot(df["BytesProcessados"], df["ThresholdBPS"],    color="orange", linewidth=1.5, linestyle="--", label="Threshold (+20%)")
